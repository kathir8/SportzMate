...
import { IonFooter, IonImg, IonContent } from '@ionic/angular/standalone';
...
@Component({
  ...
  imports: [IonFooter, IonicButtonComponent, IonicInputComponent, FormsModule, CountryDropdownComponent, IonImg, IonContent]
})
